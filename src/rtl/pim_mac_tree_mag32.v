...
// =============================================================================
// PIM MAC Tree — MAG_WIDTH=32, Q_POINT=24 variant
// Identical to pim_mac_tree.v except accumulator → accumulator_param
// =============================================================================

module pim_mac_tree_mag32 (
    input  logic          clk,
    input  logic          rst_n,
    input  logic          i_start,
    ...
    // ========================================================================
    // Scalar Accumulator Instance (MAG_WIDTH=32, Q_POINT=24)
    // ========================================================================
    logic        acc_done;
    logic [15:0] acc_result;
    logic        acc_latch0_sign_unused;
    logic [31:0] acc_latch0_mag_unused;
    logic        acc_latch1_sign_unused;
    logic [31:0] acc_latch1_mag_unused;

    accumulator_param #(.MAG_WIDTH(32), .Q_POINT(24)) u_accumulator (
        .clk       (clk),
        .rst_n     (rst_n),
        .i_start   (tree_done),
        .i_acc_en  (acc_en_d1),
    ...
    // ========================================================================
    // All-bank vector16 Accumulator Instances (MAG_WIDTH=32, Q_POINT=24)
    // ========================================================================
    ...
    logic [31:0] abk_acc_latch0_mag_unused [0:15];
    logic [31:0] abk_acc_latch1_mag_unused [0:15];

    generate
        for (genvar bank = 0; bank < 16; bank = bank + 1) begin : ABK_ACC
            accumulator_param #(.MAG_WIDTH(32), .Q_POINT(24)) u_accumulator_bank (
                .clk       (clk),
                .rst_n     (rst_n),
